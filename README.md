...
- [V] Tweet Details Page: User can tap on a tweet to view it, with controls to retweet, favorite, and reply.
- [V] Profile page:
   - [V] Contains the user header view
   - [V] Contains a section with the users basic stats: # tweets, # following, # followers
- [V] Home Timeline: Tapping on a user image should bring up that user's profile page
- [V] Compose Page: User can compose a new tweet by tapping on a compose button.
...
<img src='https://github.com/nanxinjin/myTwitter/blob/master/myTwitter/twitter2%20walkthrough.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
