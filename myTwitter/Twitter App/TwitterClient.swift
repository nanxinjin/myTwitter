...
class TwitterClient: BDBOAuth1SessionManager {
    ...
    static let shared = TwitterClient(baseURL: NSURL(string: "https://api.twitter.com") as URL!, consumerKey: "BAYH3WiEjHhBQAHfiQh4GvmyG", consumerSecret: "ozyisZp4ZU91VtOgLSHGXoqqawgX6O2Hi0qFeCD4FJhX6wrDWd")
