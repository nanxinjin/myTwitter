...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        tweetsNavigationController.tabBarItem.image = #imageLiteral(resourceName: "home-icon")
        
        let profileViewController = storyboard.instantiateViewController(withIdentifier: "ProfileViewController")
        profileViewController.tabBarItem.title = "Me"
        profileViewController.tabBarItem.image = #imageLiteral(resourceName: "profile-Icon")
        
        let tabBarController = UITabBarController()
        tabBarController.viewControllers = [tweetsNavigationController, profileViewController]
